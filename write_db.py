from helper.db_data_gen import DBDataGen
from helper.mysql import MySQL
from helper.dbclient import DBClient
import setting


class GenPOC_MR_CFG_CURVE(DBDataGen):
...
class GenPOC_MR_CFG_FACTOR(DBDataGen):
    def get_create_table_sql(self) -> str:
        return """
...
class GenPOC_MR_FND_MKD_CURVE(DBDataGen):
    def get_create_table_sql(self) -> str:
        return """
